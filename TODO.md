...
- [x] 通过 Playwright 申请勤務時間修正，并为变更增加预览、指纹确认和写后复核（支持单段勤務及可选单段休憩，或精确的「勤務時間を削除」申请）
- [x] 查询本人申请列表和详情，创建休假申请，并撤回可操作的本人申请
- [x] 为已批准的本人申请创建取消申请；绑定原申请、理由、审批路径和新申请编号，并复用管理员审批流程完成后续批准
...
- [ ] 为现有条件式批量审批增加持久化策略状态、可导出的 dry-run 报告与审计日志
